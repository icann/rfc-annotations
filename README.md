# Annotated RFC Repository

The annotated RFC repository tool allows a user to view a set of RFCs with relevant annotations.
...
This release of the annotated RFC repository is aimed at the RFCs that relate to the DNS.
All errata are shown in-line, and preliminary custom annotations include descriptions of
how each RFC is updated by others.
The primary intended audiences of this repository are security researchers, DNS software developers,
